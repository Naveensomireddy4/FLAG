...
class clientAVG(Client):
    def __init__(self, args, id, train_samples, test_samples, **kwargs):
        ...
        #print(f"in cliavg {self.classes_per_task}  {self.round_per_task} {args.patterns_per_experience} {args.sample_size} ")
          
        self.agem_plugin = AGEMPlugin(args = args,patterns_per_experience=args.patterns_per_experience, sample_size=args.sample_size)
